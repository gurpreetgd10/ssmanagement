 ...
 * @author vineetarora
 */
public class addstore extends javax.swing.JFrame  implements Serializable{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Create New Store");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        try{
            ...
            if(conn1.isValid(1)){
                ...
                p1=conn1.prepareStatement("insert into STOREADMIN values(?,?,?,?)");
                p1.setString(1, name);
                p1.setString(2, id);
